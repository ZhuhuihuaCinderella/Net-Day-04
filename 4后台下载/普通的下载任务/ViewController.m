...
- (IBAction)stopDownload:(id)sender {
    //[self.downloadTask cancel];//取消下载
    if(_resumeData)
    {
        _downloadTask = [_currentSession downloadTaskWithResumeData:self.resumeData];
...
- (IBAction)startDownload:(UIButton *)sender {
    [self dowmFile];
    //调用这个方法 可以获的你取消下载的那个时候 已经获得的数据 resumeData
...
- (void)dowmFile {
    ...
    //"http://jameswatt.local/123.mp3"
    //1
    NSURL *url = [NSURL URLWithString:@"http://111.7.130.207/cache/dldir1.qq.com/qqfile/QQforMac/QQ_V4.0.6.dmg?ich_args=cdd49b3f25f18c0a344aeeb64422b91e_7071_0_0_6_565b6306a1c9920a65071b6b95e85d8623604bb2b110bd95102a43e66ed69650_dc405cb5256640263cf80aef8d9c85c3_1_0&ich_ip="];
    //2
    NSURLRequest *request = [NSURLRequest requestWithURL:url];
    //3 NSURLSessionConfiguration （回话的配置，后台配置）
    //注意这个ID,整个手机所有后台任务都是
    NSURLSessionConfiguration *config = [NSURLSessionConfiguration backgroundSessionConfigurationWithIdentifier:@"com.xxx.xxapp"];
    //4
