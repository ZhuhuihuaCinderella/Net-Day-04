...
- (void)viewDidLoad {
    ...
    [self loadDataSource];
    [self.tableView registerClass:[CustomAppTableViewCell class] forCellReuseIdentifier:@"dcellID"];
}
- (void)loadDataSource {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.updatePriceLable.text = [NSString stringWithFormat:@"现价:￥%.2f",app.currentPrice];
    [cell configData:app];
    return cell;
}
